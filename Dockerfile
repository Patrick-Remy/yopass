...
ARG ROUTER_TYPE
ARG SHOW_FEATURES
ARG SHOW_ONE_CLICK_LINK
RUN PUBLIC_URL="${PUBLIC_URL}" PUBLIC_DECRYPTION_URL="${PUBLIC_DECRYPTION_URL}" ROUTER_TYPE="${ROUTER_TYPE}" SHOW_FEATURES="${SHOW_FEATURES}" SHOW_ONE_CLICK_LINK="${SHOW_ONE_CLICK_LINK}" yarn build
